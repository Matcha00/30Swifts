...
@interface CHNavigationDropdownMenu() <UITableViewDelegate,UITableViewDataSource>
...
@implementation CHNavigationDropdownMenu
...
#pragma mark Property  layzer  method
...
- (UITableView *)menuTableView
{
    if (!_menuTableView) {
        ...
        _menuTableView = [[UITableView alloc]initWithFrame:self.menuBackgroundView.frame style:UITableViewStylePlain];
        ...
        _menuTableView.tableFooterView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 0, 0.1)];
...
- (void)setDataSource:(id<CHNavigationDropdownMenuDataSource>)dataSource
{
...
- (void)setDelegate:(id<CHNavigationDropdownMenuDelegate>)delegate
{
    _delegate = delegate;
...
- (void)menuAction:(CHNavigationDropdownMenu *)sender
{
...
{
    if ([self.dataSource respondsToSelector:@selector(animateWithDuration:animations:)]) {
